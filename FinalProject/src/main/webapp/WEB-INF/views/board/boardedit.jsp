	...
	$(document).ready(function(){
	    ...
	    $("#btnUpdate").click(function(){
	        ...
	        var editFrm = document.editFrm;
	        	editFrm.title.value = subjectval;
...
<div style="border: 0px solid blue; width: 40%; margin: 0 auto;">
	<form name="writeFrm" enctype="multipart/form-data">
		<table id="table">
			<tr>
				<td>	
					<input type="hidden" name="fk_userid"  value="leess" readonly />
					<input type="text" name="name" style="width: 685px; border:none;" value="qwer1234$" readonly/>
				</td>				
			</tr>
			<tr>
				<td>
					<input type="text" placeholder="제목" name="title" style="width: 685px; color:black; font-size: 18pt;" id="subject" class="form-control" value="${boardvo.title}"/>
				</td>
			</tr>
			<tr>
            	<td>
            	<textarea name="content" id="content" rows="10" cols="100" style="width:95%; height:500px;">${boardvo.comments}</textarea>
	...
	<form name="editFrm">
		<input type="hidden" name="seq_board" value="${boardvo.seq_board}" />
		<input type="hidden" name="title" />
		<input type="hidden" name="content" />
	</form>
		<button type="button" style="color: black; margin-left: 40%;" id="btnUpdate">수정완료</button>
