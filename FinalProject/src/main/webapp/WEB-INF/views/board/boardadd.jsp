...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    ...
	    $("#btnWrite").click(function(){
			...
			frm.action = "<%= request.getContextPath() %>/boardaddEnd.action";
			frm.method = "POST";
			frm.submit();
	    });
...
<div style="width: 100%; height: 100%;" >
	<div style=" padding-top:10%; background-size: cover; width: 100%; height: 100%; background-image:url('<%= request.getContextPath() %>/resources/images/writee.jpg')">
<div style="margin: 2% auto; width: 45%; background-color: white; border-radius: 10px;">
	<h2 style="padding-left: 2%; padding-top: 2%;">자 유 게 시 판</h2>
	<hr style="border-color:black;"/>


<div style="border: 0px solid blue; width: 90%; margin-left: 10%;">
	<form name="writeFrm" enctype="multipart/form-data">
		<table id="table">
			<tr>
				<td>	
					<input type="hidden" name="fk_userid"  value="${sessionScope.loginuser.userid}" readonly />
					<input type="text" name="name" style="width: 685px; border:none;" value="${sessionScope.loginuser.name}" readonly/>
				</td>				
			</tr>
			<tr>
				<td>
					<input type="text" placeholder="제목" name="title" style="width: 685px; color:black; font-size: 18pt;" id="subject" class="form-control" />
				</td>
			</tr>
			<tr>
            	<td>
            	<textarea name="content" id="content" rows="10" cols="100" style="width:95%; height:500px;"></textarea>
		...
		--%>	
         	...
         	<tr>
         		<td>파일첨부<input type="file" name="attach" style="padding-top: 2%;"/></td>
         	</tr>
		...
		<button type="button" style="color: black; margin-left: 40%;" id="btnWrite">등록</button>
		<button type="button" style="color: black; margin-bottom: 3%;" onClick="javascript:history.back();">취소</button>
</div>
</div>
</div>
</div>
